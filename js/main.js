...
var zodiac = [
 {
    sign: "aries",
   day: "You will meet special people today",
   image: "img/aries.png"
 },
 {
 	sign: "aquarius",
 ...
 {
 	sign: "cancer",
 	day: "Wont be that good but still there is hope",
 ...
 {
 	sign: "capricorn",
 	day: "mindgames and trouble",
 	image: "img/capricon.png"
 },
 {
 	sign: "pisces",
 	day: "able to handle anything coming on the way",
 	image: "img/pisces.png"
 },
 {
   sign: "libra",
   day: "Unhindered motion and fluctuation",	
   image: "img/libra.png"
 },
 {
 	sign: "sagittarius", 
 ...
 {
   sign: "taurus",
   day: "very practical day, have to analyze",
   image: "img/taurus.png"	
 },
 {
 	sign: "virgo",
 	day: "secure and self-willed day with good fortune",
 	image: "img/virgo.png"
 },
 {
 	sign: "gemini",
...
console.log("users value lowercase is: " + userInput.toLowerCase());
	...
	if(userdata.value.toLowerCase() === zodiac[i].sign) {
		...
		document.getElementById("sign").textContent = "Not one of the signs. Try again!";
